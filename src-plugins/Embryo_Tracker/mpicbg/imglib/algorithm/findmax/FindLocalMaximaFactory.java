...
public class FindLocalMaximaFactory<T extends RealType<T>> implements Factory {
	 ...
	 * @param overTime
	 */
	public FindLocalMaximaFactory(Image<T> img, boolean overTime) {
		this.image = img;
	 ...
	 */
    public LocalMaximaFinder<T> createLocalMaximaFinder() {
    	...
    	case 2:
    		...
    		if (overTime) {
    			...
    			return new FindMaxima2D<T>(image);    			
    		}
    	...
    	case 3:
    		...
    		if (overTime) {
    			...
    			return new FindMaxima3D<T>(image);
    		}
