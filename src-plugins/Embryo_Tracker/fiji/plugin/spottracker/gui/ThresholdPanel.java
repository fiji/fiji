...
public class ThresholdPanel <K extends Enum<K>>  extends javax.swing.JPanel {
	...
	*/
	public static void main(String[] args) {
		...
		double mean;
		fiji.plugin.spottracker.Feature[] features = new fiji.plugin.spottracker.Feature[] { 
				fiji.plugin.spottracker.Feature.CONTRAST, 
				fiji.plugin.spottracker.Feature.ELLIPSOIDFIT_AXISPHI_A, 
				fiji.plugin.spottracker.Feature.MEAN_INTENSITY };
		EnumMap<fiji.plugin.spottracker.Feature, double[]> fv = new EnumMap<fiji.plugin.spottracker.Feature, double[]>(fiji.plugin.spottracker.Feature.class);
		for (fiji.plugin.spottracker.Feature feature : features) {
		...
		// Create GUI
		ThresholdPanel<fiji.plugin.spottracker.Feature> tp = new ThresholdPanel<fiji.plugin.spottracker.Feature>(fv);
		tp.resetAxes();
