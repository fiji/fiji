...
class FlowJCanvas extends ImageCanvas
{
        ...
        public void mouseMoved(MouseEvent e)
        {
                ...
                if (display instanceof FlowJError)
                {
                        ...
                        posLabel.setText(x + ", " + y + ": psi = " + fe.psi(x, y)+"�");
                }
                else if (display instanceof FlowJFlow)
                {
                        ...
                        if (flow.full(x, y))
                        {
                                alphaField.setText("" + IJ.d2s(flow.getAlphaDeg(x, y), 2)+"�");
        ...
        public void mouseReleased(MouseEvent e)
        {
                ...
                if (display instanceof FlowJFlow && imp.getRoi() instanceof Roi)
                {
                        ...
                        alphaField.setText("avg orientation: " + IJ.d2s(flow.averageAlpha(), 2)+"�");
                ...
                {
                        FlowJError fe = (FlowJError) display;
                        alphaField.setText("avg psi: " + IJ.d2s(((FlowJError) display).average(imp.getRoi()), 2)+"�");
                        rLabel.setText("");
                        posLabel.setText("");
                }
        }
