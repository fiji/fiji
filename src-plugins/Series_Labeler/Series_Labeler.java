...
public class Series_Labeler implements ExtendedPlugInFilter,
	...
	public int showDialog(ImagePlus imp, String command,
		...
		Panel pStartup = createNumericFieldPanel("Startup",
			start, 10);
		pStartup.setLocation(left, 30);
		
		// add a panel for the interval settings
		Panel pInterval = createNumericFieldPanel("Interval",
			interval, 10);
		...
		Panel pEveryNth = createNumericFieldPanel("Every_n-th",
			frameMask, 0);
		pEveryNth.setLocation(left, 90);
		
		// add panel for First Frame setting
		Panel pFirstFrame = createNumericFieldPanel("First",
			first, 0);
		pFirstFrame.setLocation(280, 30);
		
		// add panel for Last Frame setting
		Panel pLastFrame = createNumericFieldPanel("Last",
			last, 0);
		...
		Panel pLocationX = createNumericFieldPanel("X_",
			x, 0, 20, 50);
		locationXTextField =
		...
		Panel pLocationPresets = createComboBoxPanel(
