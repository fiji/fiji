...
/** A dynamic array of {@code float} numbers. Provides more flexibility than {@code float[]} objects and more efficiency than {@code java.util.Vector} objects. */
public class FloatArray {
	...
	*/
	public FloatArray(final int length) {
