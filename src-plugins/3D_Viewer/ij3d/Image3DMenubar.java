...
public class Image3DMenubar extends MenuBar implements ActionListener, 
	...
	private MenuItem animationAxis;
	...
	public Menu createViewMenu() {
		...
		animationAxis = new MenuItem("Change animation axis");
		animationAxis.addActionListener(this);
		view.add(animationAxis);
	...
	public void actionPerformed(ActionEvent e) {
		...
		else if(src == animationAxis)
			executer.changeAnimationAxis();
