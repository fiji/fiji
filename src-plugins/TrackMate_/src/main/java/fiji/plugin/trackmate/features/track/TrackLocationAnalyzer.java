...
public class TrackLocationAnalyzer<T extends RealType<T> & NativeType<T>> implements TrackFeatureAnalyzer<T>, MultiThreaded, Benchmark {
	...
	public TrackLocationAnalyzer(final TrackMateModel<T> model) {
		this.model = model;
		setNumThreads();
	}
