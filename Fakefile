...
CLASSPATH(plugins/TrackMate_.jar)=plugins/3D_Viewer.jar:plugins/loci_tools.jar:jars/fiji-lib.jar:jars/imglib.jar:jars/imglib-ij.jar:jars/imglib-io.jar:jars/imglib-algorithm.jar:jars/jdom.jar:jars/jgraph.jar:jars/jgrapht-jdk1.6.jar:jars/jfreechart-1.0-13.jar
